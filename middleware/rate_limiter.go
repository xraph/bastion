...
// AllowForKey checks rate limit for the given key.
...
// Config returns the rate limiter's configuration.
func (rl *RateLimiter) Config() RateLimitConfig {
	return rl.config
}

// BucketCount returns the number of active per-client buckets.
